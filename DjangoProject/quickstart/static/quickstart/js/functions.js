...
function populateName(event) {
  ...
  function populateDropDown(event) {
    ...
    if (value == 'update') {
      console.log("testing")
      var id_title = document.getElementById("shop_recovery_id_title").style.display = 'block'
      document.getElementById("shop_recovery_name_title").style.display = 'block'  
      document.getElementById('shop-recovery-id').style.display = 'block'
      document.getElementById('shop_recovery_name').style.display = 'block'

    } else {
      document.getElementById("shop_recovery_id_title").style.display = 'none'
      document.getElementById('shop_recovery_name_title').style.display = 'none'  
      document.getElementById('shop-recovery-id').style.display = 'none'
      document.getElementById('shop_recovery_name').style.display = 'none'
    }
  }